  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <img onClick={() => fileRef.current.click()} src={formData.avatar || currentUser.avatar ||    defaultAvatar} alt="User avatar"
        ...
        <input type="text" onChange={handleChange} placeholder='username' id='username' defaultValue={currentUser.username} className='border p-3 rounded-lg' />
        <input type="text" onChange={handleChange} placeholder='email' id='email' defaultValue={currentUser.email} className='border p-3 rounded-lg' />
        <input type="password" onChange={handleChange} placeholder='New password' id='password' className='border p-3 rounded-lg' />
